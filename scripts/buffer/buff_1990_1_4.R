## --------------------------------------------------------------------------
# buf_1990_1_4.R
# identify 1/4 of 1990 tracts to keep for 1990 data
# author: tjh
...
orleans_buf <- st_buffer(orleans_ctr, 2675)
...
wayne_buf <- st_buffer(wayne_ctr, 6500)
...
stl_buf <- st_buffer(stl_ctr, 2400)
...
riverside_buf <- st_buffer(riverside_ctr, 17800)
...
orange_buf <- st_buffer(orange_ctr, 4000)
...
tarrant_buf <- st_buffer(tarrant_ctr, 8100)
...
essex_buf <- st_buffer(essex_ctr, 2200)
...
allegheny_buf <- st_buffer(allegheny_ctr, 4400)
...
hamilton_buf <- st_buffer(hamilton_ctr, 3975)
...
write_csv(tracts_1990_all, "tracts_1990_1_4_remove.csv")
