...
# between 1990, 2000, 2010, and 2015-19 in US counties
# This creates a file called county_validation.csv
## --------------------------------------------------------------------------------------------
...
## --------------------------------------------------------------------------
## Read in 1990, 2000, 2010, and 2015-19 housing unit data
...
county_validation <- county_hu %>%
  ...
  rename("1990" = ESA001,                               # rename variables
         "2000" = FKI001,
         "2010" = IFC001,
         "2019" = ALZJE001) %>%
  mutate(diff10_90 = `2010` - `1990`,                   # calculate difference between 2010 and 1990
         diff19_90 = `2019` - `1990`) %>%               # calculate difference between 2019 and 1990
  arrange(diff10_90) %>%
...
## --------------------------------------------------------------------------
## create smaller tibble of nine counties included in the validation
county_validation %>%
