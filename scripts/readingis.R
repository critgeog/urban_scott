### --------------------------------------------------------------------------
### PULL in TRACT/BG SHAPEFILES, 1990, 2000, 2000, and 2019
### --------------------------------------------------------------------------
...
# I need 1990, 2000, and 2010 census tracts
...
## Set URL and JSON call to get 1990-2010 tract shapefiles
...
result <- POST(url, add_headers(Authorization = th_ipums_key), body = mybody_json, encode = "json", verbose())  # "Status" should be "200 OK"
res_df <- content(result, "parsed", simplifyDataFrame = TRUE)
...
data_extract_status_res <- GET(shp_url, add_headers(Authorization = th_ipums_key))
