...
tracts_ham_est <- tracts_2010_county %>%
  group_by(COUNTYA) %>%
  mutate(
    j90 = sum(JSDE005,JSDE006,JSDE007,JSDE008,JSDE009,JSDE010),   # sum of hu/tracts in county, YSB 1939-1989
    i90 = (JSDE005+JSDE006+JSDE007+JSDE008+JSDE009+JSDE010),      # YSB Built 1939 or earlier + ... + YSB Built 1980-1989
    hmadj = (HU1990/j90),
    ham_est90 = (HU1990/j90) * i90,
    j00 = sum(JSDE004,JSDE005,JSDE006,JSDE007,JSDE008,JSDE009,JSDE010), # sum of hu/tracts in county, YSB 1939-1999
    i00 = (JSDE004+JSDE005+JSDE006+JSDE007+JSDE008+JSDE009+JSDE010), # YSB Built 1939 or earlier + ... + YSB Built 1990-1999
    hamadj00 = (HU2000/j00),
